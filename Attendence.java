...
public class Attendence  {
    ...
    static String uname="tcgsikar1";
    static String upass="dxyudxrkwigjbzvd";
    static String reciver,sender,Subject,body;
...
//                        System.out.println("table created sucessfully");
                        ...
                        if (emailResult.next()) {
                            ...
                            msg.setSubject("Registeration Successfully ");
                            msg.setRecipient(Message.RecipientType.TO,new InternetAddress(em));
                            body="Dear "+n+" We are delighted to inform you that your enrollment registration has been successfully. " +
    ...
    void forget(){
        ...
        SendOTP.setBounds(130, 140, 100, 30);
        ...
        SendOTP.addActionListener(e ->  {
                try {
                    ...
                    while (rs.next()) {
                     ...
                     if (tf.getText().equals(UserId)) {

                         pwd1 = new Random();
                         passw = pwd1.nextInt(000000, 999999);
                         Properties prop=new Properties();
                         prop.put("mail.smtp.port","587");
                         prop.put("mail.smtp.host","smtp.gmail.com");
                         prop.put("mail.smtp.auth","true");
                         ...
                         Message msg=new MimeMessage(session);
                         msg.setSubject("Your reset otp");

                         msg.setRecipient(Message.RecipientType.TO,new InternetAddress(UserId));
                         body= String.valueOf(passw);
                         msg.setText("Dear user your One Time Password (OTP) for your Login Password forgot is "+ body+"." +
                                 " Please do not share One Time Password anyone" );
                         Transport.send(msg);
     ...
     submit.addActionListener(e ->  {
                ...
                try {
                    ...
                    String otp = String.valueOf(passw);
                    String p=mob.getText();
                    System.out.println(p);
                    System.out.println(passw);
                    if (p.equals(otp)) {
                        System.out.println("Prahlidf");
                        Class.forName("com.mysql.cj.jdbc.Driver");
                        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Attendence", "root", "12345");
